...
covid_tonline_rest <- covid_tonline[c(7401:30166),]


# for HPC -----------------------------------------------------------------


names(covid_tonline_copy)
covid_tonline_rest$lemmatized_text <- NULL

write_csv(covid_tonline_rest, file = "csv_for_ner_vienna_copy_all.csv")
